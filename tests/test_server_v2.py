...
class ServerTests(unittest.TestCase):
    ...
    def test_new_assets_served(self):
        for name in ('dashboard.js','v2.js','dashboard.css','regression-demo.json','debugger.html','rollout.js','rollout.css','rollout-demo.json','benchmark.html','benchmark.js','benchmark-results.json'):
