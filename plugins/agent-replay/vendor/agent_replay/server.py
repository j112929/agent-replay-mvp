...
def make_handler(directory,web_root,project):
    ...
    class Handler(Base):
        def do_GET(self):
            ...
            allowed={'/','/index.html','/legacy.html','/app.js','/core.js','/demo.js','/styles.css','/dashboard.js','/dashboard.css','/v2.js','/regression-demo.json','/debugger.html','/rollout.js','/rollout.css','/rollout-demo.json','/benchmark.html','/benchmark.js','/benchmark-results.json','/agent-replay-mvp.zip'}
            if path in allowed:
